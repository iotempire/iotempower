...
..  code-block:: cpp
    ...
    hx711(name, scx_pin, dout_pin/*, calfactor is by default 450*/ /*, calibration is by default false*/); /* replace one full comment with , 450 (for numbers) or , false (for booleans) if you want to change the defaults. */
