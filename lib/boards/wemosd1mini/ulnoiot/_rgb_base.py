...
class RGB_Base(Device):
    def __init__(self, name, pin, ignore_case=True, on_change=None):
        self.is_on=False
    ...
    def _set_rgb_list(self,a,no_write=False):
        if len(a) == 3: # r,g,b
            ...
            self.set(*_c.get(a[1]), led_num=int(a[0]),
                     no_write = no_write)
    ...
    def _command_rgb(self,msg):
        self._ani_stop()
        self._set_rgb_list(self._split(msg),no_write=False)
